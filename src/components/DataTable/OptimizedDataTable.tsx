...
// Optimized row component without hover effects
const OptimizedTableRow = memo<{
  ...
  <div 
    ...
    `}
  >
    <div className="grid grid-cols-12 gap-6 px-8 py-4 items-center">
...
export const OptimizedDataTable: React.FC<OptimizedDataTableProps> = ({
  ...
  const getPageNumbers = () => {
    ...
    if (totalPages <= maxVisible) {
      ...
      const start = Math.max(0, Math.min(totalPages - maxVisible, currentPage - 3));
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200/50 px-8 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900">Optimized Data Table</h3>
          ...
          <div className="flex items-center space-x-4">
            ...
            {hasFilters && (
              <div className="flex items-center space-x-2 bg-green-50 px-4 py-2 rounded-full">
                ...
                <span className="text-sm font-medium text-green-700">Filtered</span>
              </div>
            )}
        ...
        <div className="mt-6 pt-4 border-t border-gray-200">
          <div className="flex items-center justify-between text-xs text-gray-500 mb-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">Performance Cache</span>
            </div>
